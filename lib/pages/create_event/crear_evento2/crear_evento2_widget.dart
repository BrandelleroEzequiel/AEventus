...
class CrearEvento2Widget extends StatefulWidget {
  const CrearEvento2Widget({
    super.key,
    required this.eventCreado,
  });

  final DocumentReference? eventCreado;
...
class _CrearEvento2WidgetState extends State<CrearEvento2Widget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EventRecord>(
      stream: EventRecord.getDocument(widget.eventCreado!),
      builder: (context, snapshot) {
        ...
        final crearEvento2EventRecord = snapshot.data!;
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  safeSetState(() {});
                                  await widget.eventCreado!.delete();
                            ...
                            context.pushNamed(
                              ...
                              queryParameters: {
                                'eventCreado': serializeParam(
                                  crearEvento2EventRecord,
                                  ParamType.Document,
                                ),
                              }.withoutNulls,
                              extra: <String, dynamic>{
                                'eventCreado': crearEvento2EventRecord,
                              },
                            );
                          },
