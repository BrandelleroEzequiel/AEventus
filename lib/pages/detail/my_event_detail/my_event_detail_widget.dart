                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    FFAppState().banderaBoleana4 = false;
                                    safeSetState(() {});
                                  },
                                ),
                              ),
                              ...
                              children: [
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      FFAppState().banderaBoleana4 = true;
                                      safeSetState(() {});
                                    },
                                    child: Container(
                                      width: double.infinity,
                                                        ...
                                                        children: [
                                                          Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '1bjny7de' /* Estadisticas del evento */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
