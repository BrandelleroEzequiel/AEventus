...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AllCupones',
          path: '/allCupones',
          builder: (context, params) => const AllCuponesWidget(),
        ),
        FFRoute(
          name: 'AllUsers',
          path: '/allUsers',
        ...
        FFRoute(
          ...
          path: '/promocionDetail',
          requireAuth: true,
          builder: (context, params) => PromocionDetailWidget(
            promocionReference: params.getParam(
              'promocionReference',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['promocion'],
            ),
          ),
        ),
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => const CreatePromocionWidget(),
        ),
        FFRoute(
          name: 'EditUser',
          path: '/editUser',
        ...
        FFRoute(
          name: 'PantallaAEventus',
          path: '/pantallaAEventus',
          builder: (context, params) => const PantallaAEventusWidget(),
        ),
        FFRoute(
          name: 'Login',
          path: '/login',
        ...
        FFRoute(
          name: 'MisCupones',
          path: '/misCupones',
          builder: (context, params) => const MisCuponesWidget(),
        ),
        FFRoute(
          name: 'MyProfile',
          path: '/myProfile',
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'objUserParam': getDoc(['user'], UserRecord.fromSnapshot),
          },
          builder: (context, params) => UserDetailWidget(
            objUserParam: params.getParam(
              'objUserParam',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'cuponEdit': getDoc(['promocion'], PromocionRecord.fromSnapshot),
          },
          builder: (context, params) => EditCuponWidget(
            cuponEdit: params.getParam(
              'cuponEdit',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: 'MyPromocionDetail',
          path: '/myPromocionDetail',
          requireAuth: true,
          builder: (context, params) => MyPromocionDetailWidget(
            promocionReference: params.getParam(
              'promocionReference',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          path: '/myEventDetail',
          requireAuth: true,
          builder: (context, params) => MyEventDetailWidget(
            eventReference: params.getParam(
              'eventReference',
              ParamType.DocumentReference,
              isList: false,
